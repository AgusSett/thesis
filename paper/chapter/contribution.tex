...
\begin{figure}[H]
	...
	\begin{align}
		...
		\langle r, \star \rangle &\rightleftarrows r \\
		r &\rightleftarrows \star \\
		r &\rightleftarrows \star \\
	\end{align}
...
Mientras que para el caso de la abstracción, la interpretación se define de modo que dado cualquier término $u$ fuertemente normalizante, permite concluir que $t [u]$ es fuertemente normalizante.
...
La prueba de este teorema corresponde a la definición de la función \func{adequacy}, que se define por inducción sobre el término.
...
Por ejemplo, en la prueba del lema de la abstracción hora aparecen los dos constructores \const{inj₁} y \const{inj₂} del tipo suma.
