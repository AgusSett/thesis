...
\begin{prooftree*}
	...
	\hypo{\boldsymbol{\omega}}
	\infer2[($\equiv$)]{ \vdash \lambda x.x x: \top }
...
Notar que la finitud de las secuencias de reducción termina siendo dada por la caracterización inductiva, dado que para construir un término de tipo \type{SN} se deben aplicar una cantidad necesariamente finita de constructores \const{sn}.
