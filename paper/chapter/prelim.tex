...
Por lo tanto, la proyección $\pi_{((R \times S) \rightarrow S) \times T } \langle \lambda x^{R \times S}.x, t \rangle$ es está bien tipada.
A continuación se muestra como emplear la regla $dist_e$ para reducir una proyección:
