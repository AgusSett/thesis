...
\begin{frame}{Approach 2}
	\begin{tikzpicture}[overlay, remember picture, shift=(current page.south west)]
		\only<2>{\draw[red,thick,rounded corners] (5.18583, 4.93981) rectangle (7.44361, 4.55309);}
		\only<3>{\draw[red,thick,rounded corners] (7.79639, 3.35364) rectangle (8.99583, 2.82575);}
	\end{tikzpicture}
...
\begin{frame}{Approach 3}
	\begin{tikzpicture}[overlay, remember picture, shift=(current page.south west)]
		\only<1>{\draw[red,thick,rounded corners] (6.70278, 4.83659) rectangle (7.90222, 4.37797);
			\draw[red,thick,rounded corners] (3.77472, 4.34142) rectangle (5.18583, 3.95336);
		}
	\end{tikzpicture}
