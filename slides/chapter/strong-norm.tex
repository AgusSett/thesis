...
\begin{frame}{Approach 1}
	...
	\begin{tikzpicture}[overlay, remember picture, shift=(current page.south west)]
		\only<2>{\draw[red,thick,rounded corners] (4.40972, 4.41488) rectangle (5.29167, 4.02683);
		\draw[red,thick,rounded corners] (4.23333, 3.66981) rectangle (5.715, 3.17592);}
		\only<3>{
		\draw[red,thick,rounded corners] (7.54944, 3.66981) rectangle (9.13694, 3.17592);}
	\end{tikzpicture}
...
\begin{frame}{Approach 2}
	...
	\pause
	Sin embargo, construir la interpretación de la abstracción resulta particularmente complejo:
